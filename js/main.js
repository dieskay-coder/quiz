...

{
  ...
  const quizSet = shuffle([ //shuffle().splice()で、シャッフルした問題の中から特定の数を出す。
    ...
    {q: 'ひなまつりは　なんがつ　なんにち', c:['３がつ３にち', '５がつ５にち', '１２がつ２５にち']},
    {q: 'あおとあかをまぜるとなにいろになる？', c:['むらさき', 'ピンク', 'みどり']},
    {q: 'スイカはどのきせつにとれる？', c:['なつ', 'ふゆ', 'あき']},
    {q: 'いちばんさむいきせつは？', c:['ふゆ', 'なつ', 'はる']},
    {q: '１０こあるリンゴから　３つたべると　いくつになる？', c:['７こ', '３こ', '８こ']},
    {q: '１００に１をたすと　いくつになる？', c:['１０１', '９９', '２００']},
    {q: '「○○もあるけば　ぼうにあたる」○○にはいるのは？', c:['いぬ', 'ねこ', 'たぬき']},
    {q: '「○○からぼたもち」○○にはいるのは？', c:['たな', 'いす', 'つくえ']},
    {q: 'ほかのひとが　いやがることを、わざとすることって、なんていう？', c:['いじわる', 'あいさつ', 'いねむり']},
    {q: 'すわったままで　ねむることを、なんていう？', c:['いねむり', 'いじわる', 'おやすみ']},
    {q: 'じぶんよりも　としが　したの、おとこのきょうだいを　なんていう？', c:['おとうと', 'おとうふ', 'いもうと']},
    {q: 'うすい　パンの　あいだに、にくや　やさいを　はさんだ　たべものを　なんていう？', c:['サンドイッチ', 'ピクニック', 'おいなり']},
  ]).splice(0, 5); //spliceをつかうことで、最初の3個を取り出せる
